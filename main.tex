...
% ---------- 正文（划分为多个独立文件依次导入） ---------- %
\input{mainbody/ch1} \clearpage\vspace*{0pt} %\vspace*{0pt}的添加解决了章节标题前间距不合理的问题
\input{mainbody/ch2} \clearpage\vspace*{0pt}
\input{mainbody/ch3} \clearpage\vspace*{0pt}
\input{mainbody/ch4} \clearpage\vspace*{0pt}
\input{mainbody/conclusions} \clearpage\vspace*{0pt} % 结论
% ================================================== %
...
% ---------- 致谢 ---------- %
\input{mainbody/acknowledgments}
% ================================================== %
